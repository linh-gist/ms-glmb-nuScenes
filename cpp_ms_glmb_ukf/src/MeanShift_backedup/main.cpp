...
//    std::cout << "File: " << argv[1] << std::endl;
    std::vector<Point> points = getPointsFromCsv("D:\\dataset\\tracking\\CMC\\reid_ms\\ms_glmb_ukf\\test.csv");
    std::cout << "Number of points: " << points.size() << std::endl;
    std::cout << "Number of dimensions: " << points[0].dimensions() << std::endl;
    float bandwidth = 0.3;//std::stod(argv[2]);
    ...
    writeClustersToCsv(clusters, "clusters.txt");
